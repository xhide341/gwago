...
-- CreateEnum
CREATE TYPE "SalesChannel" AS ENUM ('DIRECT', 'SHOPEE', 'LAZADA', 'TIKTOK', 'OTHER');
...
CREATE TABLE "Order" (
    ...
    "salesChannel" "SalesChannel" NOT NULL DEFAULT 'DIRECT',
...
-- AddForeignKey
ALTER TABLE "InventoryStock" ADD CONSTRAINT "InventoryStock_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "Variant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
